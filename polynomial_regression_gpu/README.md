...
Hello, this is my second article about how to use modern C++ for solving machine learning problems. I continue description with polynomial regression problem described in previous [article](https://github.com/Kolkir/mlcpp/tree/master/polynomial_regression), but now I will show how can we .
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE2MTQwNDg1OV19
-->