...
4. **Generating new data for testing model predictions**
	Generating new data is very straight forward, I generate contiguous values from min value to max value of original ``X``, with  
	``` cpp
	  size_t n = 2000;
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcwNjEyMzEyOSw3ODY3Njc5ODcsNzIwMz
