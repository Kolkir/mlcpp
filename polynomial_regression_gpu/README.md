...
6. **Batch gradient descent implementation**
	 For this example a code for learning model and results predicting I moved to separate class. It helps to reuse code more easily and make its usage more clear. Also here I implemented  
	``` cpp
	template <typename Device, typename DType>
	class Optimizer {
	 public:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA2NzQ2MjE2MCwyMTM5MjE5MTc5LDk4Mz
