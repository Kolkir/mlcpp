...
Hello, this is my second article about how to use modern C++ for solving machine learning problems. I continue with polynomial regression problem described in previous [article]().
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgyMDI3Mjk0XX0=
-->