...
\end{pmatrix}
   ...
   So the goal is to estimate the parameters vector $\vec{b}$. In this tutorial I will use gradient descent for this task.
2. **Downloading data**
...
12. **Plot results**
    ...
    ![plots](plot.png)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMDIwMjQ1NTQsMjEwMzIyNjMxNywtOD
